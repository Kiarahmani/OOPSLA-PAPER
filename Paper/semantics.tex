...
\begin{array}{lclcl}
  \multicolumn{5}{c}{
    {\delta} \in \texttt{Replicated\; Data\; Type} \spc\spc
    {v} \in \texttt{Value}\spc\spc
    {op} \in \texttt{Operation\; Name}
  }\\
  \multicolumn{5}{c}{
    {s} \in \texttt{Session\; Id} \spc\spc
    {i} \in \texttt{Effect\; Id} \spc\spc
    {r} \in \texttt{Replica\; Id}
  }\\
  \eff & \in & \mathtt{Effect} & \coloneqq &  (s,i,op,v)\\
  F_{op} & \in & \texttt{Op.\,Def.} & \coloneqq & \delta \rightarrow \eta\\
