...
\lstset{escapeinside={(*@}{@*)}}
\input{insbox}
\usepackage[backend=biber,style=numeric-comp,maxbibnames=99,firstinits=true]{biblatex}
...
\keywords{Runtime Safety Enforcement and Montoring, Weak Consistency, Distributed
Systems, Haskell}
\end{abstract}
